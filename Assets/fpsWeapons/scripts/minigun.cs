...
public class minigun : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (ControlFreak2.CF2Input.GetButton("ThrowGrenade") && !myanimation.isPlaying && inventory.grenade>0 && canfire2)
		{
		...
		if (ControlFreak2.CF2Input.GetButton("Melee") && !myanimation.isPlaying && canfire2) 
		{
