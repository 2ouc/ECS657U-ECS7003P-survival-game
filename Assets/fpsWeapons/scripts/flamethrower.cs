...
public class flamethrower : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (ControlFreak2.CF2Input.GetButton("ThrowGrenade") && myanimation[fireAnim.name].speed == 0f)
		{
		...
		if (ControlFreak2.CF2Input.GetButton("Melee")  && myanimation[fireAnim.name].speed == 0f) 
		{
		...
		{	
			...
			if (ammo <= 0f)
			{
				canfire = false;
				canreload = false;
				if ((ControlFreak2.CF2Input.GetButton("Fire1") && canfire || ControlFreak2.CF2Input.GetAxis ("Fire1")>0.1) || raycastfire.playerDetected)
				{
		...
		if ((ControlFreak2.CF2Input.GetButton("Fire1") || ControlFreak2.CF2Input.GetAxis ("Fire1")>0.1) || raycastfire.playerDetected 
			&& canfire && !isreloading && !myanimation.IsPlaying (readyAnim.name)&& !myanimation.IsPlaying (hideAnim.name))
		{
