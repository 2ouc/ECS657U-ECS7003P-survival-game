...
public class molotov : MonoBehaviour {
	...
	void Update () 
	{
		...
		else if (ControlFreak2.CF2Input.GetButton("Fire1") || ControlFreak2.CF2Input.GetAxis ("Fire1")>0.1  && myanimation.IsPlaying (idleAnim.name) || raycastfire.playerDetected && !isreloading && canfire)
		{
